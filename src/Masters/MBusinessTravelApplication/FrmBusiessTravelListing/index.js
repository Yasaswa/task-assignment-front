...
function FrmBusinessTravelListing({ compType = 'Transactions' }) {
    ...
    let reportName = "Official Journey Report";
    ...
    const FnShowAllReportRecords = async (reportIdentifierKey) => {
        debugger
        try {
            const summaryRptApiCall = await fetch(`${process.env.REACT_APP_BASE_URL}/api/report/FnShowAllReportRecords?reportType=${'summary'}&viewName=${'hmv_official_travel_applications_rpt'}`)
    ...
    const infoForUpdate = async (leaves_transaction_id, key, modules_forms_id) => {
        if (key === 'view') {
            navigate("/Masters/MBusinessTravelApplication/FrmBusinessTravelEntry", { state: { leavesId: leaves_transaction_id, keyForViewUpdate: 'view', compType: compType, modules_forms_id: modules_forms_id } })
        } else {
            navigate("/Masters/MBusinessTravelApplication/FrmBusinessTravelEntry", { state: { leavesId: leaves_transaction_id, keyForViewUpdate: key, compType: compType, modules_forms_id: modules_forms_id } })
        }
    }
    ...
    const openForm = () => {
        ...
        navigate("/Masters/MBusinessTravelApplication/FrmBusinessTravelEntry", { state: { leavesId: 0, keyForViewUpdate: 'add', compType: compType, modules_forms_id: access_control.modules_forms_id } })
    }
        ...
        <>
            ...
            <DashboardLayout>
                <div className='main_heding'>
                    <label className='erp-form-label-lg'>Official Journey Application</label>
                </div>
...
export default FrmBusinessTravelListing;
